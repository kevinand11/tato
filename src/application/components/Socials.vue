<template>
	<div class="flex px-4 py-16 md:px-8 md:py-24 lg:p-16 lg:py-20 flex-col justify-center items-center">
		<div class="bg-dark rounded-3xl p-8 md:p-12 lg:px-32 flex flex-col md:flex-row items-center w-full">
